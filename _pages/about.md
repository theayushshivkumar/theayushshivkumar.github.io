...
- **Master's Thesis:** Multi-epoch spectroscopic study of the protoplanetary disk **HD 163296**, combining observations from JWST/MIRI, X-shooter, ESPaDOnS, Keck/NIRSPEC, and TESS.
  
- **Physical Research Laboratory (PRL):** Investigating protostellar outflows and gas kinematics using ALMA observations.
  
- **Data Science Minor Project on Gamma-Ray Bursts:** Built a new simulation framework for optically-thin GRBs.
